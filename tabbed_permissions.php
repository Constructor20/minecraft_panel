...
// Replace the entire PERMISSIONS section between the comments
$oldPermSection = <<<'BLADE'
    {{-- === PERMISSIONS === --}}
...
$view = str_replace($oldPermSection, $newPermSection, $view);

// Add the tab switching JS
$view = str_replace(
...
echo "Admin view updated with user tabs for permissions\n";
